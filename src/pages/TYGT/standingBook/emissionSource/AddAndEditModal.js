...
class AddAndEditModal extends PureComponent {
  ...
  getSelectDataList = (id) => {
    ...
    this.props.dispatch({
      ...
      this.setState({
        Pfy_MaterialType: autoFormDatas.Pfy_MaterialType ? autoFormDatas.Pfy_MaterialType.dataSource : [],
        Pfy_ConveyingMode: autoFormDatas.Pfy_ConveyingMode ? autoFormDatas.Pfy_ConveyingMode.dataSource : [],
        Pfy_ClosedMode: autoFormDatas.Pfy_ClosedMode ? autoFormDatas.Pfy_ClosedMode.dataSource : [],
        Pfy_StorageMaterialType: autoFormDatas.Pfy_StorageMaterialType ? autoFormDatas.Pfy_StorageMaterialType.dataSource : [],
        Pfy_OperationMode: autoFormDatas.Pfy_OperationMode ? autoFormDatas.Pfy_OperationMode.dataSource : [],
      })
    })
  }
      ...
      >
        <Row>
          ...
          <Col span={12}>
            ...
            >
              <Select placeholder="请选择排放源类型" onChange={(v) => this.setState({ emissionType: v })}>
                {
            ...
            <>
              ...
              <Col span={12}>
                <Form.Item
                  ...
                  name="TransferVol"
                >
                  <InputNumber style={{ width: '100%' }} placeholder="请输入中转存储容积（m³）" />
                </Form.Item>
              </Col>
              <Col span={12}>
                <Form.Item
              ...
              <Col span={12}>
                <Form.Item
                  label="最终存储容积（m³）"
                  name="FinalStorageVol"
                >
                  <InputNumber style={{ width: '100%' }} placeholder="请输入最终存储容积（m³）" />
                </Form.Item>
              </Col>
            </>
          }
