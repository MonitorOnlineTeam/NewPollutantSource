...
const PointStatisticalAnalysis = props => {
  ...
  const { dispatch, pageTitle, entCode, DGIMN, warningForm } = props;
  ...
  const [dataType, setDataType] = useState('region'); //region/ent/point
    ...
    <BreadcrumbWrapper>
      <div className={styles.PageWrapper}>
        ...
        <Row gutter={[0, 16]} style={{ height: 360, marginTop: 10 }}>
          ...
          <Col span={12} style={{ height: '100%' }}>
            <Card
              ...
              bodyStyle={{ padding: '10px 24px', height: 'calc(100% - 41px)' }}
              title={<div className="innerCardTitle">排放口数据缺失统计</div>}
            >
              <ReactEcharts
                option={getOption3()}
        ...
        <Card
          ...
          title={<div className="innerCardTitle">排放口数据缺失情况</div>}
        >
          <SdlTable
            loading={loading}
            align="center"
