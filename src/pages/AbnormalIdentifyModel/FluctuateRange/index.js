...
const dvaPropsData = ({ loading, common }) => ({
  ...
  loading: loading.effects['AbnormalIdentifyModel/StatisNormalRange'],
  exportLoading: loading.effects['AbnormalIdentifyModel/ExportStatisNormalRange'],
});
...
const Index = props => {
  ...
  const ExportStatisNormalRange = () => {
    const values = form.getFieldsValue();
    dispatch({
      type: 'AbnormalIdentifyModel/ExportStatisNormalRange',
      payload: { ...values, entCode: values.entCode || [] },
    });
  };
  ...
  return (
    <BreadcrumbWrapper>
      ...
      <Modal
        ...
        bodyStyle={{ padding: 0 }}
      >
        <AssistDataAnalysis displayType="modal" DGIMN={currentData.DGIMN} defaultActiveKey="1" />
      </Modal>
      <Modal
        title=""
        wrapClassName="spreadOverModal"
