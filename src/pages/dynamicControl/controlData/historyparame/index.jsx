...
class Index extends Component {
  constructor(props) {
    ...
    this.state = {
      dgimn:
        props.location.query && props.location.query.type === 'alarm'
          ? props.location.query.dgimn
          : '',
      title: '',
    };
  }
  ...
  render() {
    ...
    return (
      <div id="historyparData">
        {location.query && location.query.type === 'alarm' ? null : (
          <NavigationTree
            onItemClick={(value, selectItem) => {
              this.changeDgimn(value, selectItem);
            }}
          />
        )}
        ...
        {location.query && location.query.type === 'alarm' ? (
          ...
          <BreadcrumbWrapper extraName={`${title}`}>
            {dgimn ? (
              <HistoryparData dgimn={dgimn} initLoadData location={this.props.location} />
            ) : (
              <PageLoading />
            )}
          </BreadcrumbWrapper>
