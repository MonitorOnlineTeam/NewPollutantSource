...
export default function createThem(AMap, data, map, flag) {
  // 克里金插值参数
  var params = {
  ...
  var drawKriging = function () {
    ...
    if (values.length >= 3) {
      ...
      var grid = kriging.grid(polygon, variogram, (ylim[1] - ylim[0]) / 100);
      // 创建新图层
