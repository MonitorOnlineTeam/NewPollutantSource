...
class Rate extends Component {
  ...
  render() {
    ...
    return (
      <ContentItemWrapper title="运行分析" height={190}>
        <div className={styles.Rate}>
          <div className={styles.echartsContent}>
            <div className={styles.echartItem}>
              ...
              <div className={styles.YMNum}>
                <div>同比 <ArrowUpOutlined style={{ color: '#00FF36', fontSize: 16 }} /></div>
                <div>环比 <ArrowDownOutlined style={{ color: '#F83753', fontSize: 16 }}  /></div>
              </div>
            </div>
            <div className={styles.echartItem}>
              <ReactEcharts
