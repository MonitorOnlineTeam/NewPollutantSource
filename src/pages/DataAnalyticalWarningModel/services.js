...
export async function GetModelList(params) {
  const result = await post('/rest/PollutantSourceApi/Mold/GetMoldList', params);
  return result;
}

// 获取报警记录
export async function GetWarningList(params) {
  const result = await post('/rest/PollutantSourceApi/Warning/GetWarningList', params);
  return result;
}

// 获取报警及核实信息（上、下）
export async function GetSingleWarning(params) {
  const result = await post('/rest/PollutantSourceApi/Warning/GetSingleWarning', params);
  return result;
}
...
export async function GetSnapshotData(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/GetSnapshotData?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function SetMoldStatus(params) {
  const result = await post('/rest/PollutantSourceApi/Mold/SetMoldStatus', params);
  return result;
}

// 获取点位参数配置
export async function GetPointParamsRange(params) {
  const result = await post('/rest/PollutantSourceApi/Warning/GetPointParamsRange', params);
  return result;
}
...
export async function GetModelInfoAndParams(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/GetModelInfoAndParams',
    params,
  );
  return result;
}
...
export async function SaveModelInfoAndParams(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/SaveModelInfoAndParams',
    params,
  );
  return result;
}
...
export async function GetModelRelationDGIMN(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/GetModelRelationDGIMN',
    params,
  );
  return result;
}
...
export async function GetAllTypeDataListForModel(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/GetAllTypeDataListForModel',
    params,
  );
  return result;
}
...
export async function ExportHourDataForModel(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/ExportHourDataForModel',
    params,
  );
  return result;
}
...
export async function StatisPolValueNumsByDGIMN(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/StatisPolValueNumsByDGIMN',
    params,
  );
  return result;
}
...
export async function StatisLinearCoefficient(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/StatisLinearCoefficient',
    params,
  );
  return result;
}
...
export async function StatisNormalRange(params) {
  const result = await post('/rest/PollutantSourceApi/Warning/StatisNormalRange', params);
  return result;
}
...
export async function ExportStatisNormalRange(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/ExportStatisNormalRange',
    params,
  );
  return result;
}
...
export async function RegenerateNomalRangeTime(params) {
  const result = await post(
    '/rest/PollutantSourceApi/Warning/RegenerateNomalRangeTime',
    params,
  );
  return result;
}
