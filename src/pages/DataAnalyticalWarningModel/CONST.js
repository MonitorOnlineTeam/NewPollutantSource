...
export const ModelNumberIdsDatas = {
  ...
  //疑似行业数据波动范围异常, 疑似排放口数据波动范围异常
  8.1: ['b9601a0f-22af-4a07-927f-82d6369f2e12', 'C3F2FD73-5EA7-4A6B-8036-2A6E43FD0003'],
  // 疑似恒定值微小波动、疑似零值微小波动、
...
export const GetModelInfoByGuid = {
  ...
  '0fa091a3-7a19-4c9e-91bd-c5a4bf2e9827': {
    method:
      '1.气态污染物通入N₂进行仪表零点检查，渗透干燥过是否失效，SO₂可以做损失率测试，清洗管线、冷腔；2.颗粒物进行零点检查和校准；3.必要时进行手工比对验证。',
  },
  // 恒定值微小波动
  ...
  '1b9afa8d-1200-4fb1-aab0-a59936c3f22d': {
    method:
      '1.检查异常时间段是否有设备维护、校准等操作；2.检查湿度仪是否故障（检查参数，通N₂测试）；3.检查是否有用与正常运行范围浓度接近的氧标准气稀释样品气。',
  },
  // 疑似采样管线断开
  '9104ab9f-d3f3-4bd9-a0d9-898d87def4dd': {
    method:
      '正常生产工况O₂浓度接近21%，气态污染物浓度接近于0：1.检查管路是否脱落；2.检查有无人为主观故意断开测量管路；3.检查是否进行了错误的零点校准（可通入空气查看测量值）',
  },
  // 疑似采样管线不密封
  '5520e6f2-ac4a-4f24-bafd-48746a13f4a4': {
    method:
      '正常生产工况O₂浓度高于正常运行范围，污染物浓度低于正常运行范围：1.测试管路气密性；2.检查有无人为主观故意通入少量空气；',
  },
  // 气态污染物异常陡降
  '1fed575c-48d7-4eef-9266-735fe4bbdb2a': {
    method:
      '正常生产工况O₂浓度低于正常运行范围，湿度明显下降，气态污染物异常降低：1）现场查看是否有通入少量N₂人为稀释情况；2）检查异常时段有无维护校准操作',
  },
  // --------------------------------------------
  // 机组停运未做停运标识
  '928ec327-d30d-4803-ae83-eab3a93538c1': {
  ...
  '3568b3c6-d8db-42f1-bbff-e76406a67f7f': {
    method:
      '1）核实企业生产状况，停炉是否属实；2）查找O₂、温度、流速不符停炉特征原因（如氧气<19%，温度（-20~35）℃以外，流速>2m/s）；3）企业是否启炉，未及时撤销停运标记',
  },
  // -----------------
  // 烟气排放量数值异常
  'c934b575-a357-4a2c-b493-02849ce9cee3': {
  ...
  'f021147d-e7c6-4c1d-9634-1d814ff9880a': {
    method: '1）查看现场设备是否正常运行；2）是否借用本设备其他参数原始信号（如湿度信号借用到SO₂信号,断开湿度信号，观察SO₂是否变化）'
  },
  // 气态污染物波动大幅减小
