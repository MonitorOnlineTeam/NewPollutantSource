...
import SdlTable from './node_modules/@/components/SdlTable'
import { PlusOutlined,UpOutlined,DownOutlined,ExportOutlined } from '@ant-design/icons';
import { connect } from "dva";
import BreadcrumbWrapper from "./node_modules/@/components/BreadcrumbWrapper"
const { RangePicker } = DatePicker;
import { DelIcon, DetailIcon, EditIcon,PointIcon } from './node_modules/@/utils/icon'
import router from 'umi/router';
import Link from 'umi/link';
import moment from 'moment';
import RegionList from './node_modules/@/components/RegionList'
import NumTips from './node_modules/@/components/NumTips'
import styles from "./style.less"
import Cookie from 'js-cookie';
const { TextArea } = Input;
const { Option } = Select;

const namespace = 'equipmentManufacturList'




const dvaPropsData =  ({ loading,equipmentManufacturList }) => ({
  tableDatas:equipmentManufacturList.tableDatas,
  pointDatas:equipmentManufacturList.pointDatas,
  tableLoading:equipmentManufacturList.tableLoading,
  tableTotal:equipmentManufacturList.tableTotal,
  loadingAddConfirm: loading.effects[`${namespace}/addManufacturer`],
  loadingEditConfirm: loading.effects[`${namespace}/editManufacturer`],
  maxNum:equipmentManufacturList.maxNum,
})
