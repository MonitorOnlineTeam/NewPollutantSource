    ...
    return (
      <div style={{ width: '100%', height: props.height || 'calc(100vh - 64px - 24px)' }}>
        <Map
          ...
          center={
            entAbnormalList && entAbnormalList.longitude
              ? { longitude: entAbnormalList.longitude, latitude: entAbnormalList.latitude }
              : { longitude: '116.2529', latitude: '39.5420' }
          } //center 地图中心点坐标值
          zoom={11}
        >
          ...
          {entAbnormalList && entAbnormalList.longitude && (
            <Marker
              position={{
                longitude: entAbnormalList.longitude,
                latitude: entAbnormalList.latitude,
              }}
            >
          ...
          <div style={styleB}>
            <Row align="middle">
              ...
              <span style={{ paddingLeft: 5 }}>打卡位置及时间</span>
            </Row>
          </div>
        </Map>
      </div>
  ...
  return (
    <div>
      <Modal
        ...
        onCancel={() => {
          props.updateState({ entAbnormalNumVisible: false, entAbnormalList: [], taskList: [] });
