...
const dvaDispatch = (dispatch) => {
  return {
    ...
    insideOrOutsideWorkGetTaskWorkOrderList: (payload, callback) => { // 计划内or计划外 工单数 弹框
      dispatch({
