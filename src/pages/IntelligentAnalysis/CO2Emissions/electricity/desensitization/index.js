...
class index extends PureComponent {
  ...
  getCO2TableSum = () => {
    ...
    let entCode = searchForm[CONFIG_ID] ? (
      searchForm[CONFIG_ID].dbo__T_Bas_CO2Desulphurization__EntCode ? searchForm[CONFIG_ID].dbo__T_Bas_CO2Desulphurization__EntCode.value : undefined
    )
      : undefined;
    this.props.dispatch({
  ...
  render() {
    const { isModalVisible, editData, FileUuid, FileUuid2, currentTypeData, totalVisible, typeUnit, editTotalData, KEY } = this.state;
