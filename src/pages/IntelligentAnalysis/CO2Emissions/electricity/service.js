...
export async function getGHGEchartsData(params) {
  const result = await post(API.CO2EmissionsApi.GetCO2QuotaAlarm, params, null);
  return result;
}

// 获取柱状体详细数据
export async function getEchartsItemTableDataSource(params) {
  const result = await post(API.CO2EmissionsApi.GetCO2QuotaList, params, null);
  return result;
}
...
export async function getCO2MonthDischarge(params) {
  const result = await post(API.CO2EmissionsApi.GetCO2MonthDischarge, params, null);
  return result;
}

// 温室气体线性回归分析
export async function getCO2LinearAnalysis(params) {
  const result = await post(API.CO2EmissionsApi.GetCO2LinearAnalysis, params, null);
  return result;
}

// 获取温室气体排放报告
export async function getCO2ReportList(params) {
  const result = await post(API.CO2EmissionsApi.GetCO2ReportList, params, null);
  return result;
}

// 生成温室气体排放报告
export async function createReportCO2(params) {
  const result = await post(API.CO2EmissionsApi.DoReportCO2, params, null);
  return result;
}
