    ...
    this.props.dispatch({
      ...
      callback: res => {
        this.formRef.current.setFieldsValue({
          ...
          UnitCarbonContentDataType: res.UnitCarbonContentDataType || 2,
          CO2OxidationRateDataType: res.CO2OxidationRateDataType || 2,
          MonitorTime: moment(res.MonitorTime),
          GetType: res.GetType,
          EntCode: res['dbo.EntView.EntCode'],
          FossilType: res['dbo.T_Bas_CO2FossilFuel.FossilType']
            ? res['dbo.T_Bas_CO2FossilFuel.FossilType'] + ''
            : undefined,
          CrewCode: res['dbo.T_Bas_CO2FossilFuel.CrewCode'],
        });
        this.setState(
          {
                ...
                <Col span={12}>
                  ...
                  >
                    <InputNumber
                      ...
                      style={{
                        width:
                          this.state.UnitCarbonContentState == 2 ? '100%' : 'calc(100% - 64px)',
                      }}
