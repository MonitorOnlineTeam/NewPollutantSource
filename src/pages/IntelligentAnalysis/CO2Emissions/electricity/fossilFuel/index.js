...
import { Card, Modal, Form, Row, Col, Input, InputNumber, Select, Button, Popover, DatePicker, message } from 'antd'
...
class index extends PureComponent {
  ...
  countTYHL = () => {
    ...
    this.compute({
      CalType: 'p-3',
      Data: {
        '全年炉渣产量': SlagYield || 0, '炉渣平均含碳量': SlagAvgCO2 || 0, '全年飞灰产量': FlyAshYield || 0, '飞灰平均含碳量': FlyAshAvgCO2 || 0,
        '除尘效率': RemoveDustRate || 0, '消耗量': AnnualConsumption || 0, '低位发热量': LowFever || 0, '含碳量': UnitCarbonContent || 0
      }
    }, (res) => {
  ...
  render() {
    ...
    return (
      <BreadcrumbWrapper>
        <Card>
          <SearchWrapper configId={CONFIG_ID} successCallback={(searchForm) => this.searchSuccessCallback(searchForm)} />
          <AutoFormTable
            getPageConfig
            configId={CONFIG_ID}
            onAdd={() => {
                      ...
                      <>
                        <Row>
                          <Col span={24}>
                            ...
                            >
                              <InputNumber style={{ width: '100%' }} placeholder="请填写元素含碳量"
                      ...
                      <>
                        <Row>
                          ...
                          <Col span={24}>
                            ...
                            >
                              <InputNumber style={{ width: '60%' }} placeholder="请填写炉渣平均含碳量"
                                onChange={Debounce(() => this.countTYHL(), maxWait)}
                              />
                            </Form.Item>
                          </Col>
                        ...
                        <Row>
                          <Col span={24}>
                            ...
                            >
                              <InputNumber style={{ width: '60%' }} placeholder="请填写全年飞灰产量"
                                onChange={Debounce(() => this.countTYHL(), maxWait)}
                              />
                            </Form.Item>
                          </Col>
                          <Col span={24}>
                            ...
                            >
                              <InputNumber style={{ width: '60%' }} placeholder="请填写飞灰平均含碳量"
                                onChange={Debounce(() => this.countTYHL(), maxWait)}
                              />
                            </Form.Item>
                          </Col>
                        ...
                        <Row>
                          <Col span={24}>
                            ...
                            >
                              <InputNumber style={{ width: '60%' }} placeholder="请填写除尘系统平均除尘效率"
                                onChange={Debounce(() => this.countTYHL(), maxWait)}
                              />
                            </Form.Item>
                          </Col>
