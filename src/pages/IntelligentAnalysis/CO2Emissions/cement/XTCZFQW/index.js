...
class index extends PureComponent {
  ...
  render() {
    const { isModalVisible, editData, FileUuid, FileUuid2, currentTypeData, KEY } = this.state;
    ...
    return (
      <BreadcrumbWrapper>
        ...
        <Modal destroyOnClose width={1100} title={KEY ? "编辑" : "添加"} visible={isModalVisible} onOk={this.checkIsAdd} onCancel={this.handleCancel}>
          <Form
            style={{ marginTop: 24 }}
            {...layout}
            ref={this.formRef}
