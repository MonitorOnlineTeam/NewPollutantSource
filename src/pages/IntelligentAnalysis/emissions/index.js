...
export default class EntPollutantEmissions extends Component {
  ...
  getPollutant = () => {
    this.props.dispatch({
      ...
      payload: {
        configId: 'DischargePollutant',
      },
      callback: res => {
        this.setState({
          pollutantList: res.DataSource,
        });
        let defaultValue = res.DataSource[0]['dbo.T_Cod_Pollutant.PollutantCode'];
        this.handleChangePollutant(defaultValue);
      },
    });
  };
  ...
  render() {
    ...
    console.log('pollutantCodes', pollutantCodes);
      ...
      <BreadcrumbWrapper title="月度排放量统计">
        ...
        >
              ...
              <div>
                <span style={{ color: '#b3b3b3' }}>
                  ...
                  >
                    {pollutantList.map(item => {
                      return (
                        <Option key={item['dbo.T_Cod_Pollutant.PollutantCode']}>
                ...
                <span style={{ color: '#b3b3b3' }}>
                  ...
                  <DatePickerTool
                    ...
                    callback={this.handleChangeDate}
                  />
                  {/* <Select
                                    size="default"
          ...
          >
            ...
            <SdlTable
              title={() =>
                `${entName}${moment(this.props.clickDate).format('YYYY-MM')}月排放量${
                  currFlag === 1 ? '企业' : '排口'
                }统计`
              }
              style={{}}
