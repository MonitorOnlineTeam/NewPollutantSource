...
export default class TransmissionEfficiency extends Component {
  ...
  render() {
    ...
    let tableTitle = '';
    let Crumbs = [{ Name: '智能质控', Url: '' }];
    if (onlyOneEnt) {
      tableTitle = '有效传输率列表';
      Crumbs = Crumbs.concat({ Name: '有效传输率', Url: '' });
    } else {
          ...
          <Card
            ...
            extra={
              <div style={{ marginBottom: 20 }}>
                ...
                <Badge style={{ marginLeft: 35, marginBottom: 4 }} status="warning" />
                <span style={{ cursor: 'pointer' }}> 未达到平均值</span>
                <div
                  style={{
                    display: 'inline-block',
                    borderRadius: '20%',
