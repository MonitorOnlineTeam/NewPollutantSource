  ...
  getTableData = () => {
    ...
    dispatch({
      ...
      callback: data => {
            ...
            render: (text, record) => {
              return (
                <a
                  onClick={() => {
                    const {
                      overVerifyRateForm: { PollutantType, RegionCode },
                    } = this.props;
                    if (!this.state.regionLevel) {
                      ...
                      this.setState(
                        ...
                        () => {
                          this.initData(
                            PollutantType,
                            text == '全部合计' ? 'all' : record.regionCode,
                          );
                        },
                      );
                    } else {
        ...
        // let res = [{PollutantName:'全部合计',PollutantCode:'全部合计'},...res]
        data.map(item => {
          newCloum.push({
                      ...
                      this.setState(
                        {
                          regionLevel: '',
                          RegionCode:
                            record.ProvinceName == '全部合计' ? RegionCode : record.regionCode,
                        },
                        () => {
                          this.setState({
                            showDetails: true,
