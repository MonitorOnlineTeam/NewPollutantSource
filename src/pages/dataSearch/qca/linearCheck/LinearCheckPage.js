    ...
    paramsColumns: [
      ...
      },
      {
        ...
        render: (text, record, index) => {
          if (text !== '-') {
            return (
              <span style={{ color: record.state !== 0 ? '#f5222d' : '' }}>
                {text} {record.unit}
              </span>
            );
          }
    ...
    let option = {
      ...
      tooltip: {
        formatter: function(params, ticket, callback) {
          ...
          return `测量浓度:    ${params.value[0]}${currentRowData.Unit} <br />标准气浓度:    ${
            params.value[1]
          }${currentRowData.Unit}`;
        },
      },
      ...
      xAxis: [
        {
          name: `测量浓度(${currentRowData.Unit})`,
          gridIndex: 0,
          min: linearCheckChartData.coordMin[0],
          max: linearCheckChartData.coordMax[0],
        },
      ],
      yAxis: [
        {
          name: `标准气浓度(${currentRowData.Unit})`,
          gridIndex: 0,
          min:
            linearCheckChartData.coordMin[1] < 0
              ? linearCheckChartData.coordMin[1] - 5
              : linearCheckChartData.coordMin[1],
          max: linearCheckChartData.coordMax[1] + 5,
        },
      ],
      series: [
        {
          ...
          if (params) {
            ...
            if (params[0]) {
              ...
              ${params[0].seriesName}：${params[0].value}${
                currentRowData.Unit ? currentRowData.Unit : ''
              }
              <br />`;
            }
            if (params[1]) {
    ...
    return (
      <Card>
        ...
        <SdlTable
          ...
          dataSource={linearCheckTableData}
          columns={columns}
          onRow={record => {
            return {
              onClick: event => {
