    ...
    this.props.form.validateFields((err, values) => {
      if (!err) {
        ...
        if (expand) {
          ...
          pollutionData = PollutantByType.map(item => {
            return { PollutantCode: item.PollutantCode };
          });
          selectPollution = PollutantByType.map(item => {
            return {
              PollutantName: item.PollutantName,
              PollutantCode: item.PollutantCode,
              Unit: item.Unit,
        ...
        this.setState({
          ...
          DataType:
            values.dataType == undefined ? '' : values.dataType == 'Hour' ? 'HourData' : 'DayData',
          ...
          payload: {
            ...
            DataType:
              values.dataType == undefined
                ...
                : 'DayData',
            BeginTime:
              values.dateTime[0] && moment(values.dateTime[0]).format('YYYY-MM-DD 00:00:00'),
            EndTime: values.dateTime[1] && moment(values.dateTime[1]).format('YYYY-MM-DD 23:59:59'),
            ...
            children: [
              ...
              },
              {
                ...
                render: (text, record) => {
                  return (
                    <a
                      onClick={this.exCountHandle.bind(
                        this,
                        record.PollutantData['PolCode-' + item.PollutantCode],
                        record.RegionCode,
                        false,
                        record.EntCode,
                        item.PollutantName,
              ...
              },
              {
                ...
                render: (text, record) => {
                  return !record.PollutantData[`MaxMultiple-${item.PollutantCode}`] &&
                    !record.PollutantData[`MaxMultiple-${item.PollutantCode}`] === 0
                    ? '-'
                    : toDecimal3(record.PollutantData[`MaxMultiple-${item.PollutantCode}`]);
                },
              },
            ],
          };
          ...
          panes: [
            {
              ...
              content: (
                <SdlTable
                  columns={columns}
                  dataSource={this.props.RegionDataList}
      ...
      .then(() => {
        if (this.props.EntCountList.length > 0) {
          ...
          this.setState({
            ...
            entModalTitle:
              title +
              moment(BeginTime).format('YYYY年MM月DD日 HH时') +
              '至' +
              moment(EndTime).format('YYYY年MM月DD日 HH时') +
              modalSelectPollution[0].PollutantName +
              '值超标情况统计:',
          });
        } else {
          this.setState({
        ...
        <Form onSubmit={this.handleSummit} layout="inline">
            ...
            {getFieldDecorator('dataType', {
              ...
              <Radio.Group
                onChange={e => {
                  ...
                  e.target.value === 'Day'
                    ? this.childrenHand.onPanelChange([
                        moment()
                          .add(-1, 'month')
                          .startOf('day'),
                        moment().endOf('day'),
          ...
          <Form.Item>
            ...
            <Button
              ...
              loading={this.state.tableExportLoading}
            >
              <ExportOutlined />
              导出
            </Button>
                          ...
                          <Form.Item>
                            ...
                            <Form.Item>
                              {getFieldDecorator(item.PollutantCode + 'Max', {})(
                                <InputNumber
                                  size="small"
                                  style={{ marginRight: 5, marginLeft: -12, width: 50 }}
                                />,
                              )}
                            </Form.Item>
                          </Form.Item>
    ...
    return (
      <>
        <div id="siteParamsPage" className={style.cardTitle}>
          <BreadcrumbWrapper>
            <Card extra={<>{this.cardTitle()}</>} className={style.dataTable} size="small">
            ...
            >
              <div style={{ marginBottom: 10 }}>
                ...
                <Button
                  ...
                  onClick={this.EntButtonCountHandle}
                >
                  查询
                </Button>
                <Button onClick={this.EntButtonCountHandleExpor}>
                  <ExportOutlined /> 导出
                </Button>
              </div>
              {
            ...
            >
              <div style={{ marginBottom: 10 }}>
                ...
                <Button
                  type="primary"
                  style={{ marginRight: 10 }}
                  onClick={this.ExButtonCountHandle}
                >
                  查询
                </Button>
                <Button onClick={this.ExButtonCountHandleExport}>
                  <ExportOutlined /> 导出
                </Button>
              </div>
              {
            ...
            >
              <div style={{ marginBottom: 10 }}>
                <Button onClick={this.EntexportReport}>
                  <ExportOutlined /> 导出
                </Button>
              </div>
              {
            ...
            <Modal
              ...
              mask={false}
              onCancel={() => {
                this.setState({ regionDetailVisible: false, panes: [] });
              }}
            >
