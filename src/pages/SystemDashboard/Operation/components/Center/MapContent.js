...
@connect(({ loading, OperationSysDashboard }) => ({
  time: OperationSysDashboard.time,
  level1MapData: OperationSysDashboard.level1MapData,
  level4MapData: OperationSysDashboard.level4MapData,
  levelOtherMapData: OperationSysDashboard.levelOtherMapData,
  loading: loading.effects['OperationSysDashboard/GetMapOperationEquipmentOverview'],
}))
class MapContent extends PureComponent {
  ...
  loadPageData = () => {
    ...
    this.props.dispatch({
      type: 'OperationSysDashboard/GetMapOperationEquipmentOverview',
      payload: {
      ...
      return (
        <div
          style={{
            ...
            width: 200,
            height: 170,
            background: `url(/SystemDashboard/Operation/regionTip.png)`,
