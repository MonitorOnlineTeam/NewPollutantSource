      ...
      series: [
        ...
        },
        {
          ...
          axisLabel: {
            ...
            padding: [fontSizeFn(20), fontSizeFn(-30), 0, fontSizeFn(-26)],
          }, //刻度节点文字颜色
          pointer: {
            show: false,
          },
      ...
      <div className={styles.EffectiveRateWrapper} onClick={onOpenModal}>
        <Row className={styles.rateContent}>
          ...
          <Progress
            ...
            trailColor="#0D6B8A"
            format={percent => {
              return <span style={{ color: '#00E7FF', fontSize: '1.125rem' }}>{`${percent}%`}</span>;
            }}
          />
        </Row>
        <Row style={{ marginTop: 16, padding: '0 1.25rem', flex: 1 }}>
