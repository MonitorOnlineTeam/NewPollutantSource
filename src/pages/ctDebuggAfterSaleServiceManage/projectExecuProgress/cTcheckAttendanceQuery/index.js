...
const namespace = 'cTcheckAttendanceQuery'




const dvaPropsData = ({ loading, cTcheckAttendanceQuery, global, }) => ({
  tableLoading: loading.effects[`${namespace}/GetSignInAndOffsiteSignList`],
  tableDatas: cTcheckAttendanceQuery.tableDatas,
  tableTotal: cTcheckAttendanceQuery.tableTotal,
  queryPar: cTcheckAttendanceQuery.queryPar,
...
const Index = (props) => {
  ...
  return (
    <div className={styles.cTcheckAttendanceQuerySty}>
      <BreadcrumbWrapper>
