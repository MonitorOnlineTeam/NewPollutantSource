...
import { Card, Space, DatePicker, Button, Spin, Badge } from 'antd'
...
class Single extends PureComponent {
  ...
  cardTitle = () => {
    return <Space>
      <RangePicker picker="month" value={this.state.time} onChange={(date, dateStr) => {
  ...
  render() {
    ...
    if (this.myChart) {
      console.log('11111=', this.myChart)
    }
    return (
      <>
        <NavigationTree
