...
const namespace = 'ctProjectManager'

const dvaPropsData = ({ loading, ctProjectManager,global, }) => ({
  tableDatas: ctProjectManager.tableDatas,
  pointDatas: ctProjectManager.pointDatas,
  pointDatasTotal: ctProjectManager.pointDatasTotal,
  tableLoading: ctProjectManager.tableLoading,
  tableTotal: ctProjectManager.tableTotal,
...
const Index = (props) => {
        ...
        return <span>
          ...
          <Fragment> <Tooltip  title="详情">
            <Link style={{ padding: '0 5px' }} to={{
              pathname: '/platformconfig/basicInfo/ctProjectManager/detail',
              query: {
  ...
  return (
    <div className={styles.ctProjectManagerSty}>
      <BreadcrumbWrapper>
