      ...
      <div>
        <Form onSubmit={this.handleSubmit}>
          <Row gutter={24}>
            ...
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label={'备品备件名称'}>
          ...
          <Row gutter={24}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label={'备品备件型号'}>
          ...
          <Row gutter={24}>
            ...
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label={'服务站'}>
                {getFieldDecorator('SparePartsStationCode', {
                  ...
                  >
                    {sparePartsStationList.length !== 0
                      ? sparePartsStationList.map(item => (
                          <Option key={item.SparePartsStationCode}>{item.Name}</Option>
                        ))
                      : null}
                  </Select>,
                )}
