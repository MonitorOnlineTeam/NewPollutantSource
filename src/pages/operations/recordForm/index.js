...
class Index extends Component {
    ...
    const printSpecificStyles = `
            @media print {
                ...
                * {
                ...
                .uploadSection,
                [class*="uploadSection"],
                .antd-pro-pages-emergency-todo-list-patrol-styles-uploadSection,
                [class*="-uploadSection"],
                [class*="emergency-todo-list-"] [class*="uploadSection"],
                ...
                [class*="-signatureImage"],
                [class*="emergency-todo-list-"] [class*="signatureImage"] {
                    max-width: 160px;
                    max-height: 80px;
                    object-fit: contain;
                }
    ...
    iframeDoc.write(`
            ...
            <body>
                ...
                <script>
                    ...
                    // 隐藏所有上传区域
                    document.querySelectorAll('[class*="uploadSection"], .uploadSection, [class*="styles-uploadSection"]').forEach(element => {
                        if (element) {
                            element.style.display = 'none';
                        }
                    });
  ...
  getrecordForm = () => {
    ...
    switch (typeID + '') {
      ...
      case '3': //易耗品更换记录表
        form = (
          <ConsumablesReplaceRecordContent
            TaskID={this.props.match.params.taskID}
            TypeID={this.props.match.params.typeID}
          />
        );
      ...
      case '4': //标准气体更换记录表
        form = (
          <StandardGasRepalceRecordContent
            TaskID={this.props.match.params.taskID}
            TypeID={this.props.match.params.typeID}
          />
        );
      ...
      case '5': //完全抽取法CEMS日常巡检记录表
        form = (
          <CompleteExtractionRecordContent
            TaskID={this.props.match.params.taskID}
            TypeID={this.props.match.params.typeID}
          />
        );
      ...
      case '7': //直接测量法CEMS日常巡检记录表
        form = (
          <DirectMeasurementRecordContent
            TaskID={this.props.match.params.taskID}
            TypeID={this.props.match.params.typeID}
          />
        );
      ...
      case '70': //标准溶液核查记录表
        form = (
          <StandardSolutionVerificationRecord
            TaskID={this.props.match.params.taskID}
            TypeID={this.props.match.params.typeID}
          />
        );
