...
const Index = (props) => {
    ...
    const {type,dataList,pointType,operationPlanInfoRefreshId,visible,onCancel,onFinish} = props;
    ...
    return ( <Modal
                ...
                footer={dataList?.length>0? [<Button  onClick={() => {resData()}}>
                  ...
                  <Button type="primary" loading={type==1?  props.formulatePointListLoading : props.extendPlanDateLoading} onClick={onOk}>
                    提交
                   </Button>] : null}
            >
                <Tabs
