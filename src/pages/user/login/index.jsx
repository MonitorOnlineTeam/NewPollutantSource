...
class Login extends Component {
  ...
  clearCommonData = () => { //清除公共组件数据
    ...
    dispatch({
      ...
      payload: { noFilterRegionList: [], testRegionList: [], ctRegionList:[], operationUserList: [], inspectorUserList: [], roleList: [], entList: [], noFilterEntList: [],enableEntList:[], atmoStationList: [], }
    })
    dispatch({
