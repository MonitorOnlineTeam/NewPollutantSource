...
import { entList, HGDaysData, HGQKTableData, alertData } from './mock-data'
import ReactEcharts from 'echarts-for-react';
import QCAQualifiedDays from './QCAQualifiedDays'
import AlarmCount from '@/pages/home/components/AlarmCount'
        ...
        xAxis: [
          {
            ...
            data: ['超标报警', '异常报警', '备案不符', '质控不合格', '质控仪报警']
          }
        ],
        yAxis: [
          {
    ...
    return (
      <BreadcrumbWrapper>
        <Card>
          ...
          />
          <SdlTable dataSource={alertData} columns={columns} />
        </Card>
      </BreadcrumbWrapper>
    );
  }
