...
class StandardGasRepalceRecord extends Component {
  ...
  renderItem = record => {
    ...
    if (record !== null && record.length > 0) {
      record.map((item, index) => {
        rtnVal.push(
          <tr key={index}>
            <td style={{ height: '50px', textAlign: 'center', fontSize: '14px' }}>{index + 1}</td>
            ...
            <td style={{ height: '50px', textAlign: 'center', fontSize: '14px' }}>{item.Unit}</td>
            <td style={{ height: '50px', textAlign: 'center', fontSize: '14px' }}>{item.Num}</td>
            <td style={{ height: '50px', textAlign: 'center', fontSize: '14px' }}>
              {item.Supplier}
            </td>
            <td style={{ height: '50px', textAlign: 'center', fontSize: '14px' }}>
  ...
  render() {
    ...
    const Record =
      this.props.StandardGasRepalceRecord !== null
        ? this.props.StandardGasRepalceRecord.Record
        : null;
        ...
        <table className={styles.FormTable}>
          <tbody>
            <tr>
              <td
                colSpan="2"
                style={{ width: '18%', height: '50px', textAlign: 'center', fontSize: '14px' }}
              >
                维护管理单位
              </td>
            ...
            <tr>
              <td
                colSpan="9"
                style={{ width: '18%', height: '50px', fontSize: '14px', paddingLeft: 15 }}
              >
