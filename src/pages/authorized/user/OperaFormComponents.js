 ...
 * @LastEditTime: 2024-11-21 16:08:17
...
export default class Index extends Component {
    ...
    render() {
        ...
        const formFilesData = [
            ...
            { label: '用户类型', field: 'UserType', inputNode: 'select', required: true, disabled: UserType==2 || UserType==3, list: [{ value: "1", label: '雪迪龙' }, { value: "2", label: "运维单位" }, { value: "3", label: "其他" }]},
