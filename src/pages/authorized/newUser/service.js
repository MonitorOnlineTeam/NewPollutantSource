...
export async function GetDepInfoByTree(params) {
  const result = post(API.AuthorityApi.GetDepInfoByTree, params, null);
  return result;
}
...
export async function ExportUserList(params) {
  const result = post(API.AuthorityApi.ExportUserList, params, null);
  return result;
}
...
export async function resetpwd(params) {
  ...
  const result = post(API.LoginApi.ResetPwd, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function insertPointFilterByUser(params) {
  ...
  const result = post(API.AuthorityApi.InsertPointFilterByUser, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function ResetWechat(params) {
  const result = post(API.AuthorityApi.ResetUserWechatInfo, params, null);
  return result;
}
