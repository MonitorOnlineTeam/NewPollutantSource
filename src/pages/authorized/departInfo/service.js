...
export async function getdepartinfobytree(params) {
  const result = post(API.AuthorityApi.GetDepInfoByTree, params);
  return result === null
    ? {
        data: null,
      }
...
export async function getdepartinfobyid(params) {
  ...
  const result = post(API.AuthorityApi.GetDepartInfoByID, body);
  return result === null
    ? {
        data: null,
      }
...
export async function insertdepartinfo(params) {
  ...
  const result = post(API.AuthorityApi.InsertDepartInfo, body);
  return result === null
    ? {
        data: null,
      }
...
export async function deldepartinfo(params) {
  ...
  const result = post(API.AuthorityApi.DelDepartInfo, body);
  return result === null
    ? {
        data: null,
      }
...
export async function upddepartinfo(params) {
  ...
  const result = post(API.AuthorityApi.UpdDepartInfo, body);
  return result === null
    ? {
        data: null,
      }
...
export async function getdeparttreeandobj(params) {
  const result = post(API.AuthorityApi.GetDepartTreeAndObj, params, null);
  return result === null
    ? {
        data: null,
      }
...
export async function getuserbydepid(params) {
  ...
  const result = post(API.AuthorityApi.GetUserByDepID, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function insertdepartbyuser(params) {
  ...
  const result = post(API.AuthorityApi.InsertDepartByUser, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function insertregionbyuser(params) {
  ...
  const result = post(API.AuthorityApi.InsertRegionByUser, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function getregionbydepid(params) {
  ...
  const result = post(API.AuthorityApi.GetRegionByDepID, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function getregioninfobytree(params) {
  //   const result = post(API.RegionApi.GetRegionInfoByTree, params);
  const result = post(API.RegionApi.GetXuRegions, params);
  return result;
}
// 获取企业+排口
...
export async function getpointbydepid(params, isUser) {
  ...
  const result = post(
    isUser
      ? `${API.AuthorityApi.GetUserPointAuthorizeList}${par}`
      : `${API.AuthorityApi.GetUserPointAuthorizeListBW}${par}`,
    null,
    null,
  );
  return result === null
...
export async function insertpointfilterbydepid(params) {
  ...
  const result = post(API.AuthorityApi.InsertPointFilterByDepID, body, null);
  return result === null
    ? {
        data: null,
      }
...
export async function getGroupRegionFilter(params) {
  const result = get(API.AuthorityApi.GetGroupRegionFilter, params, null);
  return result;
}
...
export async function UpdateOperationArea(params) {
  const result = post(API.AuthorityApi.UpdateOperationArea, params, null);
  return result;
}
...
export async function getTestRegionByDepID(params) {
  const result = post(API.AuthorityApi.GetTestRegionByDepID, params, null);
  return result;
}
// 调试检测区域过滤 提交
export async function insertTestRegionByUser(params) {
  const result = post(API.AuthorityApi.InsertTestRegionByUser, params, null);
  return result;
}

//部门管理 设置运维小组
export async function addSetOperationGroup(params) {
  const result = post(API.AuthorityApi.AddSetOperationGroup, params, null);
  return result;
}

//部门管理 获取设置运维小组
export async function getSetOperationGroup(params) {
  const result = post(API.AuthorityApi.GetSetOperationGroup, params, null);
  return result;
}

//部门管理 部门排序
export async function groupSort(params) {
  const result = post(API.AuthorityApi.GroupSort, params, null);
  return result;
}
