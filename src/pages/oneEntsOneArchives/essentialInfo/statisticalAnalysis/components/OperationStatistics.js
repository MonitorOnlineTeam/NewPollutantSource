              ...
              <div className={styles.statisticInfo}>
                {
                  operationsWarningData.ThisMonthTB > 0 ? (
                    <Statistic title={<span style={{ color: "#accdec" }}>同比</span>} valueStyle={{ color: "#5bf287", fontSize: 18 }} value={operationsWarningData.ThisMonthTB} prefix={<CaretUpOutlined />} />
                  ) : <Statistic title={<span style={{ color: "#accdec" }}>同比</span>} valueStyle={{ color: "#FF4E4E", fontSize: 18 }} value={operationsWarningData.ThisMonthTB} prefix={<CaretDownOutlined />} />
                }
                {
                  operationsWarningData.ThisMonthHB > 0 ? (
                    <Statistic title={<span style={{ color: "#accdec" }}>环比</span>} valueStyle={{ color: "#5bf287", fontSize: 18 }} value={operationsWarningData.ThisMonthHB} prefix={<CaretUpOutlined />} />
                  ) : <Statistic title={<span style={{ color: "#accdec" }}>环比</span>} valueStyle={{ color: "#FF4E4E", fontSize: 18 }} value={operationsWarningData.ThisMonthHB} prefix={<CaretDownOutlined />} />
                }
              </div>
            </div>
            {/* 异常报警及响应情况 */}
