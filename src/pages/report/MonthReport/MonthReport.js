...
class index extends PureComponent {
    ...
    exportReport = () => {
        ...
        let endTime = moment(moment(time).format('YYYY-MM-01 00:00:00')).add(1, 'month').add(-1, 'second').format('YYYY-MM-DD 23:59:59');
        this.props.dispatch({
    ...
    cardTitle = () => {
        ...
        return <>
            ...
            <div style={{ display: 'inline-block', verticalAlign: 'middle', width: 200, marginLeft: 10, marginRight: 10 }}><RegionList onChange={(value) => {
                //获取关注度列表
                this.props.dispatch({
                    type: pageUrl.GetEntByRegionAndAtt,
                    payload: {
            ...
            <div style={{ marginTop: 10, fontSize: 14 }}>
                ...
                <label>监测时间:</label><MonthPicker size='default' onChange={this.DatePickerHandle} defaultValue={time} style={{ marginLeft: 10, marginRight: 10 }} />
