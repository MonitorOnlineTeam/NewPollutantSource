        ...
        <Card className="contentContainer">
          ...
          <AutoFormTable
            ...
            appendHandleRows={(row, key) => {
              if (
                row['dbo.T_Bas_QCAnalyzerControlCommand.QCType'] == 1 &&
                row['dbo.T_Bas_QCAnalyzerControlCommand.StandardPollutantCode'] != 'P'
              ) {
                let endTime = row['dbo.T_Bas_QCAnalyzerControlCommand.StopTime']
                  ? row['dbo.T_Bas_QCAnalyzerControlCommand.StopTime']
                  : moment();
                    ...
                    <a
                      onClick={() => {
                        this.setState({
                          ...
                          PollutantCode:
                            row['dbo.T_Bas_QCAnalyzerControlCommand.StandardPollutantCode'],
                          ...
                          StandardPollutantName:
                            row['dbo.T_Bas_QCAnalyzerControlCommand.StandardPollutantName'], //
