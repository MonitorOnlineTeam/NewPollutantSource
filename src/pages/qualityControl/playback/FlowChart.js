...
class FlowChart extends Component {
  ...
  render() {
    const { playbackPageDate: { gasData, cemsList, QCStatus, valveStatus, totalFlow, standardValueUtin, p1Pressure, p2Pressure, flowList, standardValue, qualityControlName } } = this.props;
    return (
      <MapInteractionCSS style={{ position: 'relative', borderLeft: '1px solid #ccc' }} defaultScale={0.9}>
        ...
        {
          p2Pressure.isException ? <img className={styles.exceptionPressure} style={{ top: 568 }} src="/qualityControl/p2Exception.png" /> : null
        }
        {/* 质控仪 */}
