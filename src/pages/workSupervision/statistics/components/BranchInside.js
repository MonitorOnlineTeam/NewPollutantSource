/*
 * @Author: JiaQi
 * @Date: 2023-05-09 09:05:17
 * @Last Modified by:   JiaQi
 * @Last Modified time: 2023-05-09 09:05:17
 * @Description：部门内其他工作事项统计
 */
...
const BranchInside = props => {
  ...
  const onFinish = () => {
    ...
    props.dispatch({
      type: 'wordSupervision/StatisticsOtherWork',
      payload: {
        ...body,
      },
      callback: res => {
  ...
  const onExport = () => {
    const body = getParams();
    props.dispatch({
      type: 'wordSupervision/ExportStatisticsOtherWork',
      payload: {
        ...body,
      },
    });
  ...
  return (
    <Card title="部门内其他工作事项统计" style={{ marginTop: -24 }}>
      <Form
        name="basic"
        form={form}
        layout="inline"
