/*
 * @Author: JiaQi
 * @Date: 2023-04-24 17:25:21
 * @Last Modified by: JiaQi
 * @Last Modified time: 2023-05-08 17:02:11
 * @Description：现场检查统计
 */
...
const XCJC = props => {
  ...
  const onFinish = () => {
    ...
    props.dispatch({
      ...
      payload: {
        ...body,
        apiName: 'StatisticsInspectorOperation',
      },
      callback: res => {
        setDataSource(res);
      },
  ...
  const onExport = () => {
    ...
    props.dispatch({
      ...
      payload: {
        ...body,
        apiName: 'ExportStatisticsInspectorOperation',
      },
    });
  };
  ...
  const getColumns = () => {
    ...
    let monthColumns = [
      ...
      {
        title: '应覆盖运维人员数量',
        dataIndex: 'standPersonNum',
        key: 'standPersonNum',
      },
      {
        title: '实际覆盖运维人员数量',
        dataIndex: 'overPersonNum',
        key: 'overPersonNum',
      },
      {
        title: '达标情况',
  ...
  return (
    <Card title="现场检查统计" style={{ marginTop: -24 }}>
      <Form
        name="basic"
        form={form}
        layout="inline"
...
export default connect(dvaPropsData)(XCJC);
