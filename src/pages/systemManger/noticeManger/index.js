...
const dvaPropsData =  ({ loading,noticeManger }) => ({
  ...
  tableLoading:noticeManger.tableLoading,
...
const Index = (props) => {
  ...
  >  
      ...
      <Form.Item label="发布时间" name="ManufacturerName"  style={{margin:'0 8px'}}>
        <RangePicker  allowClear style={{width:280}}/>
      </Form.Item>
      <Form.Item label="公告状态" name="ManufacturerName"  >
      ...
      <Row>
      <Form.Item label="查看公告单位" name="ManufacturerName"  >
       <Spin size='small' spinning={false}>
              <Select placeholder='请选择' allowClear allowClear style={{width:200}}>
              {/* {
      ...
      <Form.Item label="查看公关角色" name="ManufacturerName"  style={{margin:'0 8px'}}>
        <Spin size='small' spinning={false}>
              <Select placeholder='请选择' allowClear  style={{width:280}} >
              {/* {
               systemModelNameList[0]&&systemModelNameList.map(item => {
                 return <Option key={item.Code} value={item.Code}>{item.Name}</Option>
               })
   ...
   <Modal
    ...
    >
      ...
      <Form.Item   name="ID" hidden>
        ...
        <Col span={24}>
        <Form.Item   label="发布标题" name="ManufacturerCode"  rules={[  { required: true,  }]} >
        <TextArea showCount  maxLength={50} rows={1} placeholder='请输入'   />
      </Form.Item>
      </Col>

      <Col span={24}>
        <Form.Item label='公告内容'  name="desc"  rules={[  { required: true,message:'请输入公告内容' }]}>
      ...
      <Col span={24}>
      <Form.Item label="查看公告单位" name="SystemName"  rules={[  { required: true,message:'请选择公告单位' }]}>
            <Spin size='small' spinning={false}>
      ...
      <Col span={24}>
      <Form.Item label="查看公告角色" name="SystemName2"   rules={[  { required: true,message:'请选择公告角色' }]}>
             <Spin size='small' spinning={false}>
              <Select placeholder='请选择' allowClear >
              {/* {
               systemModelNameList[0]&&systemModelNameList.map(item => {
      ...
      <Col span={24}>
        <Form.Item label="生效时间" name="Status2" rules={[  { required: true,message:'请选择生效时间' }]} >
         <DatePicker  allowClear/>
      </Form.Item>
      </Col>
      <Col span={24}>
        <Form.Item label="失效时间" name="Status222" rules={[  { required: true,message:'请选择失效时间' }]}>
          <DatePicker allowClear />
      </Form.Item>
      </Col>
