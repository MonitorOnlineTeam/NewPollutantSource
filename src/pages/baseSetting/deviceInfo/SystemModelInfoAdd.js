...
export default class SystemModelInfoAdd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            exceptrangeDate: [],
                    ...
                    <Row gutter={24}>
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('PointTypeCode', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.PointTypeCode"] : null,
                                    rules: [
                                        {
                                            required: true,
                                            message: '请选择监测点类型!',
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                {...formItemLayout}
                                label={'编号'}>
                                {getFieldDecorator('SystemNumber', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.SystemNumber"] : null,
                                    rules: [
                                        {
                                            required: true,
                                            message: '请输入编号!',
                    ...
                    <Row gutter={24}>
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                {...formItemLayout}
                                label={'系统型号'}>
                                {getFieldDecorator('SystemModel', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.SystemModel"] : null,
                                    rules: [
                                        {
                                            required: true,
                                            message: '请输入系统型号!',
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('FillInType', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.FillInType"]+ "" : '0',
                                    rules: [
                                        {
                                            required: true,
                                            message: '请选择!',
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            <FormItem
                                ...
                                {getFieldDecorator('DeleteMark', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.DeleteMark"]+ "" : '1',
                                    rules: [
                                        {
                                            required: true,
                                            message: '请选择!',
                        ...
                        <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
                            ...
                            >
                                {getFieldDecorator('ID', {
                                    initialValue: row ? row["dbo.T_Bas_SystemModelInfo.ID"] : null,
                                })(
                                    <Input placeholder="请输入" />
                                )}
                            </FormItem>
