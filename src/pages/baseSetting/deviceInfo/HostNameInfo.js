...
import HostNameInfoAdd from './HostNameInfoAdd';
/**
 * 设备主机名称
 */
    ...
    handleSubmit = e => {
        ...
        form.validateFields((err, values) => {
            if (!err) {
                ...
                if (!formData.ID) {
                    dispatch({
                        type: 'BaseSetting/AddHostNameInfo',
                        payload: {
                            ...
                            callback: result => {
                                if (result.Datas === 1) {
                                    ...
                                    message.error("同一监测点类别下的主机名称不能重复!");
                                }
                    ...
                    dispatch({
                        type: 'BaseSetting/UpdateHostNameInfo',
                        payload: {
                            ID: formData.ID,
                            PointTypeCode : formData.PointTypeCode,
                            HostNumber : formData.HostNumber,
            ...
            <BreadcrumbWrapper title="设备主机名称">
                <Card>
                    ...
                    <Modal
                        ...
                        width="50%"
                    >
                        <HostNameInfoAdd form={this.props.form} row={this.state.row} />
                    </Modal>
                </Card>
            </BreadcrumbWrapper>
        );
