...
import DeviceParametersAdd from './DeviceParametersAdd';
/**
 * 设备参数
 */
    ...
    handleSubmit = e => {
        ...
        form.validateFields((err, values) => {
            if (!err) {
                ...
                if (!formData.ID) {
                    dispatch({
                        type: 'BaseSetting/AddDeviceParametersInfo',
                        payload: {
                            PointTypeCode: formData.PointTypeCode,
                            ParatemersCode: formData.ParatemersCode,
                            ...
                            callback: result => {
                                if (result.Datas === 1) {
                                    ...
                                    message.error("同一监测点类别下的参数名称不能重复!");
                                }
                    ...
                    dispatch({
                        type: 'BaseSetting/UpdateDeviceParametersInfo',
                        payload: {
                            ID: formData.ID,
                            PointTypeCode: formData.PointTypeCode,
                            ParatemersCode: formData.ParatemersCode,
            ...
            <BreadcrumbWrapper title="设备参数信息">
                <Card>
                    ...
                    <Modal
                        ...
                        width="50%"
                    >
                        <DeviceParametersAdd form={this.props.form} row={this.state.row} />
                    </Modal>
                </Card>
            </BreadcrumbWrapper>
        );
