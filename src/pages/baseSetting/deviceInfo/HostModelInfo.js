...
import HostModelInfoAdd from './HostModelInfoAdd';
/**
 * 设备主机型号
 */
...
@Form.create()
class HostModelInfo extends Component {
    constructor(props) {
        super(props);
        this.state = {
            DataWhere: [],
    ...
    handleSubmit = e => {
        ...
        form.validateFields((err, values) => {
            if (!err) {
                ...
                if (!formData.ID) {
                    dispatch({
                        type: 'BaseSetting/AddHostModelInfo',
                        payload: {
                            HostModelNumber: formData.HostModelNumber,
                            HostModel: formData.HostModel,
                            HostModelName: formData.HostModelName,
                            ...
                            callback: result => {
                                if (result.Datas === 1) {
                                    ...
                                    message.error("同一主机名称下的主机型号不能重复!");
                                }
                    ...
                    dispatch({
                        type: 'BaseSetting/UpdateHostModelInfo',
                        payload: {
                            ID: formData.ID,
                            HostModelNumber: formData.HostModelNumber,
                            HostModel: formData.HostModel,
            ...
            <BreadcrumbWrapper title="设备主机名称">
                <Card>
                    ...
                    <Modal
                        ...
                        width="50%"
                    >
                        <HostModelInfoAdd form={this.props.form} row={this.state.row} />
                    </Modal>
                </Card>
            </BreadcrumbWrapper>
        );
