...
export default class Index extends Component {
 ...
 componentWillUnmount(){
  ...
  getAirDayReportData = () => {
    ...
    let time = moment().add('hour',-2).format("YYYY-MM-DD HH:00:00");
 ...
 */
  ...
  tabCallback = (value) => {
  let time = value == 'HourData'? moment().add('hour',-2).format("YYYY-MM-DD HH:00:00") : moment().add('day',-1).format("YYYY-MM-DD 00:00:00")
