...
export default class ContentList extends Component {
  ...
  render() {
    ...
    if (manualUploadautoParameters.BeginTime && manualUploadautoParameters.EndTime) {
      dateValue = [
        moment(manualUploadautoParameters.BeginTime),
        moment(manualUploadautoParameters.EndTime),
      ];
    }
      ...
      <Card
        ...
        title={
          <Form layout="inline">
            ...
            <Form.Item>
              <Button onClick={this.confirm}>统计AQI</Button>
            </Form.Item>
          </Form>
        }
        bordered={false}
        ...
        >
          <div class="ant-modal-confirm-body">
            ...
            <div class="ant-modal-confirm-content">
              {' '}
              确认导入模板文件中的时间点的<span style={{ color: 'red' }}>{dataType}</span>数据吗?
            </div>
          </div>
        </Modal>
      </Card>
