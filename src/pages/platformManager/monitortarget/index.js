...
export default class MonitorTarget extends Component {
  ...
  editMonitorInfo = (key, row) => {
    const {
      match: {
        params: { targetType, configId, pollutantTypes },
      },
    } = this.props;
      ...
      <BreadcrumbWrapper hideBreadcrumb={!!hideBreadcrumb}>
        <Card className={styles.contentContainer}>
          ...
          <AutoFormTable
                  ...
                  <>
                    ...
                    <Tooltip title="排放源清单台账">
                      <a
                        onClick={() => {
                          router.push(
                            `/standingBook/emissionSource/${row['dbo.T_Bas_Enterprise.EntCode']}`,
                          );
                        }}
                      >
                  ...
                  <>
                    ...
                    <Tooltip title="机组信息">
                      <a
                        onClick={() => {
                          router.push(
                            '/platformconfig/monitortarget/AEnterpriseTest/1/unitInfoPage/' +
                              row['dbo.T_Bas_Enterprise.EntCode'] +
                              '/' +
                              row['dbo.T_Bas_Enterprise.EntName'],
                          );
                        }}
                      >
            ...
            {...this.props}
          ></AutoFormTable>
          <MonitorEntElectronicFence
            visible={this.state.electronicFenceVisible}
            title={this.state.electronicFenceTitle}
            entId={this.state.entId}
            onCancel={() => {
              this.setState({ electronicFenceVisible: false });
            }}
          />
        </Card>
      </BreadcrumbWrapper>
