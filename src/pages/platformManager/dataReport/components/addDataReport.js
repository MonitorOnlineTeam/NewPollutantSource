        ...
        payload: {
          ...
          callback: res => {
            if (res.IsSuccess) {
              dispatch(
                routerRedux.push(
                  `/Intelligentanalysis/SewagePlant/DataReporting/DataReporting/${monitortime}/${entcode}`,
                ),
              );
            }
          },
      ...
      <BreadcrumbWrapper title="数据上报添加">
        ...
        >
          ...
          <div className={styles.footer}>
            ...
            <Button key="submit" type="primary" onClick={this.onSubmitForm.bind(this)}>
              确定
            </Button>
          </div>
        </Card>
