        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0', width: '100%' }}>
            {this.props.form.getFieldDecorator(`TestComponent${record.key}`, {
              rules: [{ required: true, message: '请选择分析仪名称' }],
              ...
              >
                {this.props.TestComponent.map(item => (
                  <Option
                    disabled={this.state.dataSource[index].Component.find(
                      itm => itm.TestComponent === item.ChildID,
                    )}
                    key={item.ChildID}
                    value={item.ChildID}
                  >
        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0' }}>
            {this.props.form.getFieldDecorator(`AnalyzerPrinciple${record.key}`, {
              ...
              <Input
                onChange={e => {
                  this.changeChildTable(index, 'AnalyzerPrinciple', e.target.value, idx);
                }}
              />,
            )}
          </FormItem>
          ...
          <FormItem style={{ marginBottom: '0' }}>
            {this.props.form.getFieldDecorator(`AnalyzerRangeMin${record.key}`, {
              ...
              <InputNumber
                min={-100000}
                onChange={value => {
                  this.changeChildTable(index, 'AnalyzerRangeMin', value, idx);
                }}
              />,
            )}
          </FormItem>
          ...
          <FormItem style={{ marginBottom: '0' }}>
            {this.props.form.getFieldDecorator(`AnalyzerRangeMax${record.key}`, {
              ...
              <InputNumber
                min={-100000}
                onChange={value => {
                  this.changeChildTable(index, 'AnalyzerRangeMax', value, idx);
                }}
              />,
            )}
          </FormItem>
        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0' }}>
            {this.props.form.getFieldDecorator(`MeasurementUnit${record.key}`, {
              ...
              <Input
                onChange={e => {
                  this.changeChildTable(index, 'MeasurementUnit', e.target.value, idx);
                }}
              />,
            )}
          </FormItem>
        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0', width: '100%' }}>
            {getFieldDecorator(`Type${record.key}`, {
              rules: [{ required: true, message: '请选择Cem名称' }],
              initialValue: text || undefined,
            })(
              <Select
                style={{ width: '100%' }}
              ...
              >
                {this.props.CemsList.map(item => (
                  <Option
                    disabled={this.state.dataSource.find(itm => itm.Type == item.ChildID)}
                    key={item.ChildID}
                    value={item.ChildID}
                  >
                    {item.Name}
        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0' }}>
            {getFieldDecorator(`Manufacturer${record.key}`, {
              rules: [{ required: true, message: '请填写设备生产商' }],
              initialValue: text || undefined,
            })(
              <Input
                onChange={e => {
                  this.changeMainTable('Manufacturer', e.target.value, idx);
                }}
              />,
            )}
          </FormItem>
        ...
        render: (text, record, idx) => (
          <FormItem style={{ marginBottom: '0' }}>
            {getFieldDecorator(`ManufacturerCode${record.key}`, {
              ...
              <Input
                onChange={e => {
                  this.changeMainTable('ManufacturerCode', e.target.value, idx);
                }}
              />,
            )}
          </FormItem>
