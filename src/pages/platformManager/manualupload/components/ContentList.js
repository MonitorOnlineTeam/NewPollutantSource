...
export default class ContentList extends Component {
  ...
  render() {
    ...
    if (manualUploadParameters.BeginTime && manualUploadParameters.EndTime) {
      dateValues = [
        moment(manualUploadParameters.BeginTime),
        moment(manualUploadParameters.EndTime),
      ];
    }
    ...
    const columns = [
      ...
      },
      {
        ...
        render: (text, record, index) => (
          <span>{text === 0 ? <Tag color="green">达标</Tag> : <Tag color="red">超标</Tag>}</span>
        ),
      },
      {
        title: '超标倍数',
      ...
      <Card
        ...
        title={
          <Form layout="inline">
            ...
            <Form.Item>
              <Button style={{ marginRight: 5 }} onClick={() => this.updateModel()}>
                添加
              </Button>
              {this.upload()}
              <Spin
