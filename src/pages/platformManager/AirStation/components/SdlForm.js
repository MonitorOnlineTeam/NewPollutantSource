...
import { getBase64 } from '../../../AutoFormManager/utils'
...
import SdlRadio from '../../../AutoFormManager/SdlRadio';
import SdlCheckbox from '../../../AutoFormManager/SdlCheckbox';
import SdlUpload from '../../../AutoFormManager/SdlUpload'
import MapModal from '../../../AutoFormManager/MapModal';
import SdlMap from '../../../AutoFormManager/SdlMap'
import styles from '../../../AutoFormManager/index.less'
import config from '@/config'
    ...
    return formItems.map((item, index) => {
      ...
      switch (item.type) {
        case '文本框':
          ...
          if (item.fieldName === "WarehouseNo") {
            element = <Input placeholder={placeholder} style={{ width: '90%' }} allowClear />;
          }
          else if (this.props.keysParams && item.fieldName === "DGIMN") {
            element = <Input disabled={true} placeholder={placeholder} allowClear />;
          }
          else {
