        ...
        <Form onSubmit={this.handleSubmit}>
          <Row gutter={24}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="DGIMN">
            ...
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="设备名称">
                {getFieldDecorator('VedioDevice_Name', {})(<Input placeholder="请输入设备名称" />)}
              </FormItem>
            </Col>
          </Row>
          <Row gutter={24}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="设备编号">
                {getFieldDecorator('VedioDevice_No', {})(<Input placeholder="请输入设备编号" />)}
              </FormItem>
            </Col>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
          ...
          <Row gutter={16} style={{ marginTop: 8 }}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="相机名称">
                {getFieldDecorator('VedioCamera_Name', {})(<Input placeholder="请输入相机名称" />)}
              </FormItem>
            </Col>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="相机位置">
          ...
          <Row gutter={16} style={{ marginTop: 8 }}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="通道号">
            ...
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="相机编号">
          ...
          <Row gutter={16} style={{ marginTop: 8 }}>
            <Col xs={2} sm={6} md={12} lg={12} xl={12} xxl={12}>
              <FormItem {...formItemLayout} label="生产日期">
                {getFieldDecorator('ProduceDate')(<DatePicker />)}
              </FormItem>
            </Col>
