...
export async function GetEmissionEntList(params) {
  const result = post('/api/rest/PollutantSourceApi/BaseDataApi/GetEmissionEntList', params, null);
...
export async function ExportEmissionEnt(params) {
  const result = post('/api/rest/PollutantSourceApi/BaseDataApi/ExportEmissionEnt', params, null);
...
export async function AddEmissionEnt(params) {
  const result = post('/api/rest/PollutantSourceApi/BaseDataApi/AddEmissionEnt', params, null);
...
export async function updateEntFlag(params) {
  const result = post('/api/rest/PollutantSourceApi/BaseDataApi/UpdateEntFlag', params, null);
