 ...
 */
@Form.create()
export default class SurfaceWaterPointOperationAdd extends Component {
    constructor(props) {
        super(props);
        this.state = {
            tabKey: '1',
                    ...
                    payload: {
                        ...
                        callback: result => {
                            if (result.Datas === 1) {
                                ...
                                router.push(`/basicInfo/SurfaceWaterPointOperation/SurfaceWaterPointOperation`)
                            }
                                ...
                                rowmodel && rowmodel != 'null' ?
                                    <Divider orientation="right" style={{ border: '1px dashed #FFFFFF' }}>
                                        <ButtonGroup>
                                            ...
                                            <Button onClick={() => {
                                                router.push(`/basicInfo/SurfaceWaterPointOperation/'${configId}'`)
                                            }}>
                                                返回
                                             <Icon type="right" />
                                            </Button>
