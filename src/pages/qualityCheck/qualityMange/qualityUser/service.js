...
export async function getQualityUserList(params) {
  const result = await post(API.QualityControlApi.GetOperatorList, params, null);
  return result;
}

// 删除运维人
export async function delOperatorUser(params) {
  const result = await post(API.QualityControlApi.DelOperator, params, null);
  return result;
}

// 添加运维人
export async function addOperator(params) {
  const result = await post(API.QualityControlApi.AddOperator, params, null);
  return result;
}
...
export async function deletePhoto(params) {
  const result = await post(API.QualityControlApi.DelOperatorPhoto, params, null);
  return result;
}

// 导出运维人
export async function exportOperaPerson(params) {
  const result = await post(API.QualityControlApi.ExportOperaPerson, params, null);
  return result;
}
