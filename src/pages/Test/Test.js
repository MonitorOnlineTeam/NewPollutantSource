...
class Test extends Component {
    ...
    return (
      ...
      >
        {this.state.displayType === 0 ? (
          ...
          <a>
            <GasIcon style={{ fontSize: 24 }} />
          </a>
        ) : (
          <a>
            <WaterIcon style={{ fontSize: 24 }} />
          </a>
        )}
      </div>
    );
  ...
  componentWillReceiveProps(nextProps) {
    ...
    if (defaultMapInfo !== nextProps.defaultMapInfo) {
      setTimeout(() => {
        _thismap.setZoomAndCenter(pointZoom, [
          nextProps.defaultMapInfo.Longitude,
          nextProps.defaultMapInfo.Latitude,
        ]);
        this.setState({
                    ...
                    onClick={() => {
                      ...
                      if (pointInfo) {
                        ...
                        this.setState({
                          ...
                          // currentEntInfo: entInfo[0],
                          coordinateSet:
                            this.state.currentEntInfo.CoordinateSet || this.props.coordinateSet,
                        });
                      }
                    }}
                  >
                ...
                <div className={styles.pointInfoWindow}>
                  {!this.props.tableList.length && !this.props.chartData.seriesData.length ? (
                    ...
                    <>
                      ...
                      <div
                        style={{ fontSize: 16, textAlign: 'center', padding: '10px 15px 0 15px' }}
                      >
                        {chartData.legend}24小时趋势图
                      </div>
                      <ReactEcharts
