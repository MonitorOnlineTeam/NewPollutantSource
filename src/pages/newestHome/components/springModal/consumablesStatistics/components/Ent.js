...
const dvaPropsData =  ({ loading,consumablesStatistics,global }) => ({
  tableDatas:consumablesStatistics.tableDatas,
  pointDatas:consumablesStatistics.pointDatas,
  tableLoading:consumablesStatistics.tableLoading,
  tableTotal:consumablesStatistics.tableTotal,
  abnormalLoading:loading.effects[`${namespace}/abnormalExceptionTaskList`],
  abnormalTypes:consumablesStatistics.abnormalTypes,
  dateCol:consumablesStatistics.dateCol,
  abnormalList:consumablesStatistics.abnormalList,
  ...
  insideOrOutsiderWorkTableDatas:consumablesStatistics.insideOrOutsiderWorkTableDatas,
  insideOrOutsiderWorkTableTotal:consumablesStatistics.insideOrOutsiderWorkTableTotal,
  clientHeight: global.clientHeight,
  entOutsidePointListTotal:consumablesStatistics.entOutsidePointListTotal,
  entOutsidePointListDatas:consumablesStatistics.entOutsidePointListDatas,
