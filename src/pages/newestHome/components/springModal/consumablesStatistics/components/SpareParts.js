...
const dvaPropsData = ({ loading, consumablesStatistics, global }) => ({
  ...
  exportLoading1: consumablesStatistics.exportSpareSumLoading,
  exportLoading2: consumablesStatistics.exportSpareDetailLoading,
      ...
      <>
        {tabsType == 1 ?
          ...
          >
            ...
            <Form.Item label='存货编号' name='stockCode' style={{ paddingRight: 8 }}>
              <Input placeholder='请输入' allowClear />
            </Form.Item>
            <Form.Item label='备品备件名称' name='sparePartsName' style={{ paddingRight: 8 }}>
              <Input placeholder='请输入' allowClear />
            </Form.Item>
            <Form.Item>
          ...
          >      <Row>
              <Col span={8}>
                <Form.Item label='企业名称' name='entName' className='form_label_width_97' style={{ paddingRight: 8 }}>
                  <Input placeholder='请输入' allowClear />
                </Form.Item>
              </Col>
              <Col span={8}>
