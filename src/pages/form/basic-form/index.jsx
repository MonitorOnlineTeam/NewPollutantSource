          ...
          >
              ...
              {getFieldDecorator('title', {
                rules: [
                  {
                    ...
                    message: formatMessage({
                      id: 'form-basic-form.title.required',
                    }),
                  },
                ],
              })(
                <Input
                  placeholder={formatMessage({
                    id: 'form-basic-form.title.placeholder',
                  })}
                />,
              )}
            </FormItem>
            ...
            >
              {getFieldDecorator('date', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'form-basic-form.date.required',
                    }),
                  },
                ],
              })(
                <RangePicker
                  ...
                  placeholder={[
                    formatMessage({
                      id: 'form-basic-form.placeholder.start',
                    }),
                    formatMessage({
                      id: 'form-basic-form.placeholder.end',
                    }),
                  ]}
                />,
              )}
            ...
            >
              {getFieldDecorator('goal', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'form-basic-form.goal.required',
                    }),
                  },
                ],
              })(
                <TextArea
                  ...
                  placeholder={formatMessage({
                    id: 'form-basic-form.goal.placeholder',
                  })}
                  rows={4}
                />,
              )}
            ...
            >
              {getFieldDecorator('standard', {
                rules: [
                  {
                    required: true,
                    message: formatMessage({
                      id: 'form-basic-form.standard.required',
                    }),
                  },
                ],
              })(
                <TextArea
                  ...
                  placeholder={formatMessage({
                    id: 'form-basic-form.standard.placeholder',
                  })}
                  rows={4}
                />,
              )}
            ...
            >
              {getFieldDecorator('client')(
                <Input
                  placeholder={formatMessage({
                    id: 'form-basic-form.client.placeholder',
                  })}
                />,
              )}
            </FormItem>
            ...
            >
              {getFieldDecorator('invites')(
                <Input
                  placeholder={formatMessage({
                    id: 'form-basic-form.invites.placeholder',
                  })}
                />,
              )}
            </FormItem>
            ...
            >
              {getFieldDecorator('weight')(
                <InputNumber
                  placeholder={formatMessage({
                    id: 'form-basic-form.weight.placeholder',
                  })}
                  min={0}
                  max={100}
                />,
                ...
                >
                  {getFieldDecorator('publicUsers')(
                    <Select
                      mode="multiple"
                      placeholder={formatMessage({
                        id: 'form-basic-form.publicUsers.placeholder',
                      })}
                      style={{
                        margin: '8px 0',
