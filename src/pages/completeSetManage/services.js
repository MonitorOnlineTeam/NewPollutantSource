...
export async function GetAllRegionalList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetAllRegionalList',
    params,
  );
  return result;
}
...
export async function InsOrUpdExpert(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdExpert',
    params,
  );
  return result;
}
...
export async function DeleteExpert(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteExpert?ID=' + params.ID,
    {},
  );
  return result;
}
