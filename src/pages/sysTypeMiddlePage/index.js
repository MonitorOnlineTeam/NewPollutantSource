...
class index extends PureComponent {
  ...
  render() {
    ...
    const bgImageUrl = bgImageType
      ? `url('/bgImage/${bgImageType}/middlePage_bg.jpg')`
      : `url('/middlePage/bg.jpg')`;
      ...
      <div className={styles.middleContainer}>
        <header className={styles.header}>
          ...
          <div className={styles.right}>
            ...
            <span style={{ cursor: 'pointer' }} onClick={this.onLoglout}>
              退出
            </span>
          </div>
        </header>
                ...
                return (
                  <Col className="gutter-row" span={6} onClick={() => this.onSysItemClick(item)}>
                    <div className={styles.itemContent}>
                      ...
                      <span className={styles.sysName}>{item.Name}</span>
                    </div>
                  </Col>
                );
