...
import { Card, Modal, Button, Form, Row, Col, Select, DatePicker, Tooltip, Divider, Popconfirm } from "antd"
                ...
                <Row>
                  <FormItem label={<span >异常数据类型</span>}>
                    {getFieldDecorator('DataType', {
                      ...
                      <Select mode="multiple" allowClear style={{ width: 200 }} placeholder="请选择异常数据类型">
