/*
 * @Author: JiaQi 
 * @Date: 2023-05-17 15:58:41 
 * @Last Modified by: JiaQi
 * @Last Modified time: 2023-05-17 15:59:20
 * @Description：唐银钢铁数据一览
 */
...
class Realtime extends Component {
      ...
      const columns = [
        ...
        },
        {
          ...
          render: (text, record) => {
            ...
            return (
              <Popover content={'数据不可信'} title="Title">
                {el}
              </Popover>
            );
          },
  ...
  render() {
    ...
    const { dataLoading, columnLoading, tableInfo } = this.props;
    ...
    const branchList = tableInfo['BranchFactoryModel']
      ? tableInfo['BranchFactoryModel']['dataSource']
      : [];
            ...
            <Space>
              ...
              >
                {branchList.map(item => {
                  return (
                    <Option
                      key={item['dbo.T_Bas_BranchFactory.ID']}
                      value={item['dbo.T_Bas_BranchFactory.ID']}
                    >
                      {item['dbo.T_Bas_BranchFactory.BranchFactoryName']}
                    </Option>
                  );
                })}
              </Select>
