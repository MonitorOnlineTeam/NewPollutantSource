        ...
        if (this.props.pollutantCodeList.length > 0) {
          ...
          this.props.dispatch({
            ...
            payload: {
              ...
              BeginTime: dateTime[0].format('YYYY-MM-DD HH:mm:ss'),
    ...
    if (entCode == undefined) {
      this.setState({
        ...
        ModalTitle:
          '全部合计' +
          '于' +
          moment(moment(time[0]).format('YYYY-MM-DD HH:mm:ss')).format('YYYY年MM月DD号HH时') +
          '至' +
          moment(time[1]).format('YYYY年MM月DD号HH时') +
          '超标报警' +
          deal,
              ...
              panes.push({
                ...
                content: (
                  <SdlTable
                    loading={loadingRateDetail}
                    columns={columns}
                    dataSource={this.props.AlarmDetailList}
                    // pagination={
                    //     {
                    //         showSizeChanger: true,
                    //         showQuickJumper: true,
              ...
              return (
                <a
                  onClick={this.AlarmNumHandle.bind(
                    this,
                    record.ProvinceName == '全部合计' ? this.state.regionValue : record.regionCode,
                    col.PollutantCode,
                    record.regionName,
                  )}
                >
        ...
        <div id="siteParamsPage">
          ...
          >
            <div style={{ marginBottom: 10 }}>
              ...
              <Button type="primary" style={{ marginRight: 10 }} onClick={this.AlertsButtonHandle}>
                {' '}
                查询
              </Button>
              <Button onClick={this.ButtonHandleExpor}>
                <ExportOutlined /> 导出
              </Button>
              <div style={{ marginTop: 10 }}>
          ...
          >
            <div style={{ marginBottom: 10 }}>
              ...
              <Button onClick={this.AlreadyButtonHandleExpor}>
                <ExportOutlined /> 导出
              </Button>
              <div style={{ marginTop: 10 }}>
          ...
          >
            <div style={{ marginBottom: 10 }}>
              ...
              <Button onClick={this.StayButtonHandleExpor}>
                <ExportOutlined /> 导出
              </Button>
            </div>
            {loadingDetail ? (
          ...
          >
            <div style={{ marginBottom: 10 }}>
              <Button onClick={this.ButtonCountHandleExpor}>
                <ExportOutlined /> 导出
              </Button>
            </div>
            {loadingDetail ? (
