...
export default class Index extends Component {
  ...
  render() {
    ...
    return (
      <Modal title={entName} footer={null} width="95%" visible={entVisible} onCancel={entCancel}>
        <div id="entAbnormalRecord">
          <Row>
            {' '}
            <span>异常开始时间：{startTime}</span>{' '}
            <span style={{ paddingLeft: 50 }}>异常结束时间：{endTimes}</span>
          </Row>
