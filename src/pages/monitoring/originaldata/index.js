            ...
            <Card
              extra={
                <div>
                  ...
                  >
                    <Option value="2011" disabled={disabledFourDataTypes}>
                      实时数据
                    </Option>
                    <Option value="2051" disabled={disabledFourDataTypes}>
                      分钟数据
                    </Option>
                    <Option value="2061" disabled={disabledFourDataTypes}>
                      小时数据
                    </Option>
                    <Option value="2031" disabled={disabledFourDataTypes}>
                      日数据
                    </Option>
                    <Option value="other" disabled={disabledOthers}>
                      其它
                    </Option>
                  </Select>
