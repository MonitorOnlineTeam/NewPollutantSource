            ...
            <div>
                <MapInteractionCSS
                    ...
                    <div className={styles.imgBg1} >
                        <div onClick={() => this.positionClick("i33003,i33004,i33001", "i12110,i12105")} style={{
                            position: 'relative', left: '60px',
                            top: '390px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>{this.getsystemparam('系统采样探头温度', '探头温度', '°C')}</div>
                        <div style={{
                        ...
                        <div style={{
                            ...
                            top: '580px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>{this.getsystemparam('钢气瓶压力', '钢气瓶压力', 'Pa')}</div>
                        <div
                            style={{
                                position: 'relative', left: '585px',
                        ...
                        <div style={{
                            ...
                            top: '290px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>{this.getsystemparam('电磁阀累计使用次数', '使用次数', '次')}</div>
                        <div
                            className={`${styles.divClick} ${styles.caiyangbeng1}`}>{this.getsystemparam('采样泵累计使用时间', '使用次数', '次')}</div>
                        <div style={{
                            position: 'relative', left: '365px',
                            top: '360px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>{this.getsystemparam('蠕动泵累计使用时间', '使用次数', '次')}</div>
                        <div
                          onClick={() => this.positionClick("", "i12109", "")}
                        style={{
                            position: 'relative', left: '600px',
                            top: '200px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>
                            {this.getsystemstate("制冷器")}
                        </div>
                        <div style={{
                            position: 'relative', left: '260px',
                            top: '210px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}
                        ...
                        <div style={{
                            ...
                            top: '190px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}
                            onClick={() => this.positionClick("i33003,i33004,i33001", "i12110,i12105")}>
                        ...
                        <div style={{
                            ...
                            top: '320px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>
                            {this.getsystemstate("蠕动泵状态")}
                        </div>
                        <div style={{
                            position: 'relative', left: '805px',
                            top: '300px', fontWeight: '700', fontSize: '10px', width: 300
                        }} className={styles.divClick}>
