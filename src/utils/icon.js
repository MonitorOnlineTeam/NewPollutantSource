...
export const EntIcon = props => (
  <IconConfig
    type="icon-qiye2"
    {...props}
    style={{ ...mapStyle, color: '#4e8cee', ...props.style }}
  />
);
export const MapEntIcon = props => <IconConfig type="icon-qy" style={{ ...style }} {...props} />;
export const StationIcon = props => (
  <IconConfig type="icon-huanbaojiancezhan" style={{ ...style }} {...props} />
);
export const ReachIcon = props => (
  <IconConfig type="icon-hechangzhiheduan" style={{ ...style }} {...props} />
);
export const SiteIcon = props => (
  <IconConfig type="icon-tadiaogongdijianshe" style={{ ...style }} {...props} />
);
...
export const QCAIcon = props => (
  <IconConfig type="icon-yiqiyibiao" style={{ ...style }} {...props} />
);
...
export const BellIcon = props => (
  <IconConfig type="icon-lingdang" style={{ ...styles }} {...props} />
);
...
export const WaterIcon = props => (
  <IconConfig type="icon-water" style={{ ...mapStyle }} {...props} />
);
export const WaterNormal = props => (
  <IconConfig type="icon-water-normal" style={{ ...mapStyle }} {...props} />
);
export const WaterExceed = props => (
  <IconConfig type="icon-water-exceed" style={{ ...mapStyle }} {...props} />
);
export const WaterAbnormal = props => (
  <IconConfig type="icon-water-abnormal" style={{ ...mapStyle }} {...props} />
);
export const WaterOffline = props => (
  <IconConfig type="icon-water-offline" style={{ ...mapStyle }} {...props} />
);

// 废气
export const GasIcon = props => <IconConfig type="icon-gas" style={{ ...mapStyle }} {...props} />;
export const GasNormal = props => (
  <IconConfig type="icon-gas-normal" style={{ ...mapStyle }} {...props} />
);
export const GasExceed = props => (
  <IconConfig type="icon-gas-exceed" style={{ ...mapStyle }} {...props} />
);
export const GasAbnormal = props => (
  <IconConfig type="icon-gas-abnormal" style={{ ...mapStyle }} {...props} />
);
export const GasOffline = props => (
  <IconConfig type="icon-gas-offline" style={{ ...mapStyle }} {...props} />
);

//向上、向下箭头
export const Xiangshang = props => (
  <IconConfig type="icon-jiantou_xiangshang1" style={{ ...mapStyle }} {...props} />
);
export const Xiangxia = props => (
  <IconConfig type="icon-jiantou_xiangxia1" style={{ ...mapStyle }} {...props} />
);
// 电量
