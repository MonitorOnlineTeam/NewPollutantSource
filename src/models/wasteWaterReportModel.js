...
import { GetEntByRegionAndAtt, GetPointByEntCode, GetAllTypeDataListWater, ExportAllTypeDataListWater, getReportColumns } from '../services/wasteWaterReportApi'
...
export default Model.extend({
  ...
  subscriptions: {},
  effects: {
    *GetEntByRegionAndAtt({ payload, callback }, { call, put, update, select }) {
