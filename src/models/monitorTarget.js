...
import { getPollutantTypeList, queryPointForTarget } from '@/services/baseapi';
...
export default Model.extend({
  ...
  effects: {
    ...
    *getPollutantTypeList({ payload }, { call, put, update, select }) {
    ...
    //查询监控目标下是否有点位信息
    *queryPointForTarget({ payload }, { call, put, update, select }) {
      const result = yield call(queryPointForTarget, payload.where);
