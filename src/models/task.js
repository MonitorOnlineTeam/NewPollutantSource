...
export default Model.extend({
  ...
  effects: {
    // 任务记录
    *GetTaskRecord({ payload }, { call, update, put, select, take }) {
    ...
    // 手机端运维记录详情
    *GetOperationFormDetail({ payload }, { call, update, put, select, take }) {
    ...
    // 校准记录
    *GetJzRecord({ payload }, { call, update }) {
    ...
    // },
    // 易耗品更换记录
    *GetConsumablesReplaceRecord({ payload }, { call, update }) {
    ...
    // 故障小时数记录表
    *GetFailureHoursRecord({ payload }, { call, update }) {
    ...
    // 备品更换记录
    *GetSparePartReplaceRecord({ payload }, { call, update }) {
    ...
    // 标气更换记录
    *GetStandardGasReplaceRecord({ payload }, { call, update }) {
    ...
    // 标气更换记录
    *MaintainRecordDetail({ payload }, { call, update }) {
    ...
    // 日常巡检记录
    *GetPatrolRecord({ payload }, { call, update }) {
    ...
    // 停机记录
    *GetStopCemsRecord({ payload }, { call, update }) {
    ...
    // 维修记录
    *GetRepairRecord({ payload }, { call, update }) {
    ...
    // 数据异常记录
    *GetDeviceExceptionRecord({ payload }, { call, update }) {
    ...
    // 比对监测记录
    *GetBdTestRecord({ payload }, { call, update }) {
    ...
    *GetBdTestRecordZB({ payload }, { call, update }) {
    ...
    // 获取报警响应列表
    *GetAlarmResponseList({ payload }, { call, update }) {
    ...
    /** 获取任务列表 */
    *GetOperationTaskList({ payload }, { call, update, select }) {
    ...
    *ExportOperationTaskList({ payload }, { call, update, select }) {
    ...
    // 获取运维记录
    *GetOperationLogList({ payload }, { call, update, select }) {
    ...
    // 获取任务详情处理记录附件信息
    *GetTaskDitailsAttachment({ payload }, { call, update, select }) {
    ...
    *GetWaterComparisonTestRecordForPCList({ payload }, { call, update, select }) {
    ...
    //  示值误差系统响应记录
    *GetIndicationErrorSystemResponseRecordListForPC({ payload }, { call, update, select }) {
      const DataInfo = yield call(GetIndicationErrorSystemResponseRecordListForPC, payload);
      if (DataInfo.IsSuccess) {
        yield update({
