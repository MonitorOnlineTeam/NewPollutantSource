...
import { Table, Card, Button, Modal, message, Divider, Row, Col, Tooltip, Popconfirm } from 'antd';
          ...
          <span>
            ...
            <Tooltip title="删除">
              <Popconfirm
                placement="left"
                title="确定要删除此排口吗？"
                onConfirm={() => this.deleteVideoInfobyIndex(record)}
                okText="是"
                cancelText="否"
              >
                <a href="#">
            ...
            <Tooltip title="播放">
              <a
                onClick={() => {
                  this.props.dispatch(
                    routerRedux.push(`/platformconfig/hkshowvideo/${this.props.DGIMN}`),
                  );
                }}
              >
                <PlayCircleTwoTone />
