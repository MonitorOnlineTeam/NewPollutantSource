        ...
        payload: {
          beginTime:
            this.props.startTimes == ''
              ...
              : this.props.startTimes,
          endTime:
            this.props.endTimes == '' ? endTime.format('YYYY-MM-DD HH:mm:ss') : this.props.endTimes,
    ...
    setTimeout(() => {
      ...
      this.props.dispatch({
        ...
        payload: {
          ...
          DGIMN: [this.props.DGIMN],
          Pollutant:
            this.state.Pollutant == '' ? this.props.exmodellist[0].product : this.state.Pollutant,
          ExceptionType:
            this.state.ExceptionType == '' ? this.props.exlist[1] : this.state.ExceptionType,
        },
      });
    }, 0);
  };
      ...
      <div className={styles.cardTitle}>
        ...
        >
          ...
          {this.props.exmodellistLoading ? (
            ...
            <div>
              {this.props.exmodellist.length == 0 ? (
