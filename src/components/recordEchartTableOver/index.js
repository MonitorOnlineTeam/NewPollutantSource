...
class Index extends Component {
  constructor(props) {
    ...
    this.state = {
      rangeDate:
        this.props.noticeState == 0
          ? [this.props.firsttime, this.props.lasttime]
          : [moment(new Date()).add(-60, 'minutes'), moment(new Date())],
      format: this.props.noticeState == 0 ? 'YYYY-MM-DD HH' : 'YYYY-MM-DD HH:mm:ss',
      bar: [],
      dataType: this.props.noticeState == 0 ? 'HourData' : 'RealTimeData',
      DGIMN: [],
      beginTime:
        this.props.noticeState == 0 ? this.props.firsttime.format('YYYY-MM-DD HH:mm:ss') : '',
      ...
      payload: {
        beginTime:
          this.state.beginTime == ''
            ...
            : this.state.beginTime,
        endTime:
          this.state.endTime == '' ? endTime.format('YYYY-MM-DD HH:mm:ss') : this.state.endTime,
    ...
    setTimeout(() => {
      ...
      this.props.dispatch({
        ...
        payload: {
          ...
          DGIMN: [this.props.DGIMN],
          Pollutant:
            this.state.Pollutant == '' ? this.props.overmodellist[0].product : this.state.Pollutant,
        },
      });
    }, 0);
  };
    ...
    return (
      <div className={styles.cardTitle}>
        ...
        >
          ...
          {this.props.overmodellistLoading ? (
            <Spin
              style={{
                width: '100%',
                height: 'calc(100vh/2)',
            ...
            <div>
              {' '}
              {this.props.overmodellist.length == 0 ? (
