...
export async function GetEntSummary(params) {
  const result = post(API.BaseDataApi.GetEntSummary, params, null);
  return result;
}
//获取企业详细信息
...
export async function GetEntOrPointDetail(params) {
  const result = post(API.RegionApi.GetEntOrPointDetail, params, null);
  return result;
}
//导出企业信息
export async function ExportEntSummary(params) {
  const result = post('/api/rest/PollutantSourceApi/BaseDataApi/ExportEntSummary', params, null);
  return result;
}
//导出企业详细信息
...
export async function ExportEntOrPointDetail(params) {
  const result = post(API.ExportApi.ExportEntOrPointDetail, params, null);
  return result;
}
