...
export async function GetConsumablesReplaceRecord(params) {
  ...
  const result = await post(
    API.PredictiveMaintenanceApi.GetConsumablesReplaceRecordList,
    body,
    null,
  );
  return result === null
...
export async function GetStandardGasReplaceRecord(params) {
  ...
  const result = await post(
    API.PredictiveMaintenanceApi.GetStandardGasRepalceRecordList,
    body,
    null,
  );
  return result === null
...
export async function GetDeviceExceptionRecord(params) {
  ...
  const result = await post(
    API.PredictiveMaintenanceApi.GetDeviceExceptionRecordForPCList,
    body,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetOperationTaskList(params) {
  const body = {
    params: {
      ...
      CompleteTime:
        params.CompleteTime != undefined && params.CompleteTime != ''
          ? `${params.CompleteTime[0].format(
              'YYYY-MM-DD 00:00:00',
            )},${params.CompleteTime[1].format('YYYY-MM-DD 23:59:59')}`
          : '',
      CreateTime:
        params.CreateTime != undefined && params.CreateTime != ''
          ? `${params.CreateTime[0].format('YYYY-MM-DD 00:00:00')},${params.CreateTime[1].format(
              'YYYY-MM-DD 23:59:59',
            )}`
          : '',
    },
...
export async function ExportOperationTaskList(params) {
  ...
  const result = await post(
    API.PredictiveMaintenanceApi.ExportOperationTaskList,
    body.params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetCooperationInspectionRecordList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetCooperationInspectionRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetDataConsistencyRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetRealtimeConsistencyRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
/** 示值误差系统响应记录 */
export async function GetIndicationErrorSystemResponseRecordListForPC(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetIndicationErrorSystemResponseRecordListForPC,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetDetectionTimesRecordList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetDetectionTimesRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetWaterCalibrationRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetWaterCalibrationRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetWaterCheckRecordRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetStandardSolutionRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetWaterParametersChangeRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetWaterParametersChangeRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetGasParametersChangeRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetGasParametersChangeRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
...
export async function GetWaterComparisonTestRecordForPCList(params) {
  const result = await post(
    API.PredictiveMaintenanceApi.GetWaterComparisonTestRecordForPCList,
    params,
    null,
  );
  return result === null ? { Datas: null } : result;
