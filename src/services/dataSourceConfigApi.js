...
export async function TableConfigAdd(params)
{
   ...
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/TableConfigAdd',body,null)
   return result === null ? {
       data:null
   }:result;
}
...
export async function TableConfigUpdate(params)
{
   ...
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/TableConfigUpdate',body,null)
   return result === null ? {
       data:null
   }:result;
}
...
export async function GetPkByTableName(params)
{
   ...
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/GetPkByTableName',body,null)
   return result === null ? {
       data:null
   }:result;
}
...
{
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/GetTables',params,null)
   return result === null ? {
       data:null
   }:result;
}
...
{
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/TableConfig',params,null)
   return result === null ? {
       data:null
   }:result;
}
...
{
   const result = post('/api/rest/PollutantSourceApi/AutoFormDataApi/ConfigIDisExisti',params,null)
   return result === null ? {
       data:null
   }:result;
}