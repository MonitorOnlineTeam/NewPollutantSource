...
export async function getMenuData(payload) {
  const body = {
    ...
    menu_id: sessionStorage.getItem('sysMenuId') ||  Cookie.get('sysMenuId') || '5cd1884a-3f42-426f-8893-5cae720bddf3',
    // ...payload
  };
...
export async function RecoveryUser(params) {
  const result = await post(API.AuthorityApi.RecoveryUserInfo, params);
  return result;
}
