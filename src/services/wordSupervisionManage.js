...
export async function StandbyAndInsLendOrReturn(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/StandbyAndInsLendOrReturn',
    params,
  );
  return result;
}
...
export async function DeleteOffice(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/DeleteOffice',
    params,
  );
  return result;
}
...
export async function GetAllUserByOffice(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetAllUserByOffice',
    params,
  );
  return result;
}
...
export async function InsertOfficeByUser(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/InsertOfficeByUser',
    params,
  );
  return result;
}
...
export async function GetUserByOfficeCode(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetUserByOfficeCode',
    params,
  );
  return result;
}
...
export async function GetAllManager(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetAllManager',
    params,
  );
  return result;
}
...
export async function SetOfficeManager(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/SetOfficeManager',
    params,
  );
  return result;
}
...
export async function GetToDoDailyWorks(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetToDoDailyWorks?type=' +
      (params.type || ''),
    params,
  );
  return result;
...
export async function GetWorkBenchMsg(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetWorkBenchMsg',
    params,
  );
  return result;
}
...
export async function endTask(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/FinishTasks',
    params,
  );
  return result;
}
...
export async function manualTask(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/ManualApplicationTasks',
    params,
  );
  return result;
}
...
export async function InsOrUpdReturnVisitCustomers(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdReturnVisitCustomers',
    params,
  );
  return result;
}
...
export async function getCustomerList(params) {
  const result = await post(
    `/rest/PollutantSourceApi/DailyWorkManagerApi/GetAllOtherCustomList`,
    params,
  );
  return result;
}
...
export async function getOtherCustomerList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetOtherCustomList',
    params,
  );
  return result;
}
...
export async function InsOrUpdOtherCustomer(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdOtherCustom',
    params,
  );
  return result;
}
...
export async function GetRegionalAndProvince(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetRegionalAndProvince',
    params,
  );
  return result;
}
...
export async function DeleteOtherCustom(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteOtherCustom?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function GetReturnVisitCustomersList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetReturnVisitCustomersList',
    params,
  );
  return result;
}
...
export async function DeleteReturnVisitCustomers(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteReturnVisitCustomers?ID=' +
      params.ID,
    {},
  );
  return result;
...
export async function InsOrUpdPersonTrain(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdPersonTrain',
    params,
  );
  return result;
}
...
export async function GetPersonTrainList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetPersonTrainList',
    params,
  );
  return result;
}
...
export async function ExportPersonTrainList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/ExportPersonTrainList',
    params,
  );
  return result;
}
...
export async function DeletePersonTrain(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeletePersonTrain?AttachId=' + params.ID,
    {},
  );
  return result;
}
...
export async function GetOfficeList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetOfficeList',
    params,
  );
  return result;
}
...
export async function InsOrUpdOfficeCheck(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdOfficeCheck',
    params,
  );
  return result;
}
...
export async function GetOfficeCheckList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetOfficeCheckList',
    params,
  );
  return result;
}
...
export async function DeleteOfficeCheck(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteOfficeCheck?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function InsOrUpdOtherWork(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdOtherWork',
    params,
  );
  return result;
}
...
export async function GetOtherWorkList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetOtherWorkList',
    params,
  );
  return result;
}
...
export async function DeleteOtherWork(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteOtherWork?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function exportTaskRecord(params) {
  const result = await post(
    `/rest/PollutantSourceApi/DailyWorkManagerApi/${params.apiName}`,
    {
      ...params,
      apiName: undefined,
    },
...
export async function InsOrUpdCheckAttendance(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdCheckAttendance',
    params,
  );
  return result;
}
...
export async function GetCheckAttendanceRecordList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetCheckAttendanceRecordList',
    params,
  );
  return result;
}
...
export async function DeleteCheckAttendanceRecord(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteCheckAttendanceRecord?ID=' +
      params.ID,
    {},
  );
  return result;
...
export async function GetCheckAttendanceLogList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetCheckAttendanceLogList?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function StatisticsOtherWork(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/StatisticsOtherWork',
    params,
  );
  return result;
}
...
export async function ExportStatisticsOtherWork(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/ExportStatisticsOtherWork',
    params,
  );
  return result;
}
...
export async function GetPollutantTypeList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetPollutantTypeList',
    params,
  );
  return result;
}
...
export async function InsOrUpdAccountsReceivable(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/InsOrUpdAccountsReceivable',
    params,
  );
  return result;
}
...
export async function DeleteAccountsReceivable(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteAccountsReceivable?ID=' + params.ID,
    {},
  );
  return result;
}
...
export async function GetAccountsReceivableList(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/GetAccountsReceivableList',
    params,
  );
  return result;
}
...
export async function StatisticsAccountsReceivable(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/StatisticsAccountsReceivable',
    params,
  );
  return result;
}
...
export async function DeleteTasks(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/DeleteTasks',
    params,
  );
  return result;
}
...
export async function GetManagerByType(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkBaseApi/GetManagerByType?type=' + params.type,
    {},
  );
  return result;
}
...
export async function RetransmissionTasks(params) {
  const result = await post(
    '/rest/PollutantSourceApi/DailyWorkManagerApi/RetransmissionTasks',
    params,
  );
  return result;
}
