...
export async function getAllMonthEntPollutantEmissions(params) {
  const result = await post(
    '/rest/PollutantSourceApi/EmissionsApi/GetAllMonthEntPollutantEmissions',
    params,
  );
...
export async function getSingleMonthEntPollutantEmissions(params) {
  const result = await post(
    '/rest/PollutantSourceApi/EmissionsApi/GetSingleMonthEntPollutantEmissions',
    params,
  );
...
export async function getAllMonthPointPollutantEmissions(params) {
  const result = await post(
    '/rest/PollutantSourceApi/EmissionsApi/GetAllMonthPointPollutantEmissions',
    params,
  );
...
export async function getSingleMonthAllPointEmissions(params) {
  const result = await post(
    '/rest/PollutantSourceApi/EmissionsApi/GetSingleMonthAllPointEmissions',
    params,
  );
...
export async function getSinglePointDaysEmissions(params) {
  const result = await post(
    '/rest/PollutantSourceApi/EmissionsApi/GetSinglePointDaysEmissions',
    params,
  );
