...
export async function GetExceedDataList(params) {
    const result = post(API.MonitorDataApi.GetOverDataList, params, null)
    return result
}
//超标次数查询
export async function GetExceedNum(params) {
    const result = post(API.MonitorDataApi.GetOverStandardNum, params, null)
    return result
}
//企业
...
export async function ExportExceedNum(params) {
    const result = post(API.ExportApi.ExportOverStandardNum, params, null)
    return result
}
