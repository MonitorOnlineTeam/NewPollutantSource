...
export const API = {
  ...
  VisualKanbanApi: {
    ...
    GetBWVisualDashBoardOperatePointInfo:
      before + '/BWDataApi/GetBWVisualDashBoardOperatePointInfo', //获取运维信息总览信息 宝武
  ...
  CtDebugServiceApi: {
    ...
    Export72HoursCommissioningTestPdfReport:
      '/109Api/rest/PollutantSourceApi/TaskFormApi/ImportRecord', //导出72小时调试检测报告 pdf
    /*区域权限管理*/
